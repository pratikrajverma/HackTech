  ...
  return (
    <div className='flex ml-5 border border-richblack-500 gap-20   items-center   mt-16'>
        ...
        <div className='w-[50%] flex flex-col gap-10'>
            ...
            <p className='font-medium text-[16px] w-[80%] text-richblack-300 '>Instructors from around the world teach millions of students on HackTech. We provide the tools and skills to teach what you love.</p>
